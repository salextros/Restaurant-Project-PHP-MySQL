  ...
  <!-- SECCION DE TESTIMONIO -->
    ...
    <h2>Nuestros Chefs</h2>
        <div class="row">
            ...
            <div class="card">
                <img src="images/colaboradores/team-image1.jpg" 
                class="card-img-top"
                alt="Chef 1" />
            ...
            <div class="card">
                <img src="images/colaboradores/team-image2.jpg" 
                class="card-img-top"
                alt="Chef 2" />
            ...
            <div class="card-body">
                ...
                <p class="card-text">La chef Sofia </p>
                <div class="social-icons mt-3">
                    <a href="#" class="text-dark m-2"><i class="fab fa-facebook"></i></a>
                    <a href="#" class="text-dark m-2"><i class="fab fa-instagram"></i></a>
                    <a href="#" class="text-dark m-2"><i class="fab fa-linkedin"></i></a>
...
<!-- SECCION DEL MENU -->
     ...
     <section>
        ...
        <div class="col d-flex">
            <div class="card"> 
                <img src= "menu/menu-image1.jpg" alt="Tortillas de maiz con carne y frijoles negros" class="card-img-top">
                <div class="card-body">
