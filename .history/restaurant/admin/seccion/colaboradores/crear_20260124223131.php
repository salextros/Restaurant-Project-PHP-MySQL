...
if($_POST){
  ...
  $sentencia = $conexion->prepare ("INSERT INTO `tbl_colaboradores` (`ID`, `titulo`, `descripcion`, `linkfacebook`, `linkinstagram`, `linklinkedin`, `foto`) VALUES (NULL, 'TIME_CODEMAN', 'CHEF DE LA COMIDA PICANTE', 'HTTP//: FACEBOOK', 'HTTP//: INSTAGRAM', 'HTTP//: LINKEDIN', 'FOTO.jpg');");
